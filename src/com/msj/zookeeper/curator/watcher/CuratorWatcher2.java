package com.msj.zookeeper.curator.watcher;
 ...
 * @date 2017/4/19 下午17:12
 * @copyright ©2017 孟少杰 All Rights Reserved
 * @desc Zookeeper curator PathChildrenCache
 */
		...
		cache.getListenable().addListener(new PathChildrenCacheListener() {
			...
			public void childEvent(CuratorFramework cf, PathChildrenCacheEvent event) throws Exception {
				...
				case CHILD_REMOVED:
					...
					System.out.println("CHILD_REMOVED_DATA :" + new String(event.getData().getData(),"utf-8"));
					break;
				default:
					break;
				}
